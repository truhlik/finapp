...
from ...models import BuildingSaving, Portfolio


class BuildingSavingViewSetUnauthorizedTestCase(BaseTestCase):
    view_basename = 'building-saving'
    model_class = BuildingSaving
    recipe_name = 'building_saving'
...
class BuldingSavingViewSetAuthorizedTestCase(BaseTestCase):
    view_basename = 'building-saving'
    model_class = BuildingSaving
    recipe_name = 'building_saving'
