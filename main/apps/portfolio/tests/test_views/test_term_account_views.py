...
from ...models import TermAccount, Portfolio


class TermAccountViewSetUnauthorizedTestCase(BaseTestCase):
    view_basename = 'term-account'
    model_class = TermAccount
    recipe_name = 'term_account'
...
class TermAccountViewSetAuthorizedTestCase(BaseTestCase):
    view_basename = 'term-account'
    model_class = TermAccount
    recipe_name = 'term_account'
