...
from ...models import ShareEtf, Portfolio


class ShareEtfViewSetUnauthorizedTestCase(BaseTestCase):
    view_basename = 'share-etf'
    model_class = ShareEtf
    recipe_name = 'share_etf'
...
class ShareEtfViewSetAuthorizedTestCase(BaseTestCase):
    view_basename = 'share-etf'
    model_class = ShareEtf
    recipe_name = 'share_etf'
