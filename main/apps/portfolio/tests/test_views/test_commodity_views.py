...
from ...models import Commodity, Portfolio


class CommodityViewSetUnauthorizedTestCase(BaseTestCase):
    view_basename = 'commodity'
    model_class = Commodity
    recipe_name = 'commodity'
...
class CommodityViewSetAuthorizedTestCase(BaseTestCase):
    view_basename = 'commodity'
    model_class = Commodity
    recipe_name = 'commodity'
