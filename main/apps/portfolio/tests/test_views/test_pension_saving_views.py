...
from ...models import PensionSaving, Portfolio


class PensionSavingViewSetUnauthorizedTestCase(BaseTestCase):
    view_basename = 'pension-saving'
    model_class = PensionSaving
    recipe_name = 'pension_saving'
...
class PensionSavingViewSetAuthorizedTestCase(BaseTestCase):
    view_basename = 'pension-saving'
    model_class = PensionSaving
    recipe_name = 'pension_saving'
